...
void print_sieves(int max){
    bool numbers[max]; //Allokerar minne i stacken. En boolarray används eftersom elementen i boolarrayen bara använder 1 byte var
    int i = 0;

    for (i = 0; i < max; i++) //sätter alla värden i arrayen till true
    {
        numbers[i] = true;
    }
